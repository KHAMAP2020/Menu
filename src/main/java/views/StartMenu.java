...
public class StartMenu
{
    ...
    private static RadioMenuItem schemeBrightItem = new RadioMenuItem(GUIConstants.SCHEME_BRIGHT_NAME);
    private static RadioMenuItem schemeDarkItem = new RadioMenuItem(GUIConstants.SCHEME_DARK_NAME);

    private static MenuBar menuBar = new MenuBar();

    private static Menu schemeMenu =new Menu(GUIConstants.SCHEME_NAME);
    private static MenuItem returnToStartItem = new MenuItem(GUIConstants.RETURN_TO_START_BUTTEN_STRING);
    private static MenuItem endStageItem = new MenuItem(GUIConstants.END_STAGE_BUTTON_STRING);
    ...
    public static MenuBar createMenu(Stage newStage)
    {
        ...
        schemeMenu.getItems().setAll(schemeBrightItem, schemeDarkItem);
        returnMenu.getItems().addAll(endStageItem,returnToStartItem);
        setItemEvents();

        //Initiale RadioEinstellung
        schemeBrightItem.setSelected(GUIConstants.SCHEME_BRIGHT_INITIAL_STATUS);
        schemeDarkItem.setSelected(GUIConstants.SCHEME_DARK_INITIAL_STATUS);
        updateSettings();
